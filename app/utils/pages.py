...
def page_numbering(total_count: int,
                   limit: int,
                   skip: int,
                   max_pages: int = 5) -> Tuple[List[Tuple[int, int, int]], int]:
...
def page_numbering_general_case(max_pages: int,
                                current_page: int,
                                total_page: int,
                                pages: List[Tuple[int, int, int]]) -> Tuple[
