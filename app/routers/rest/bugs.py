...
from app.database.postgre.bugs.pg_bugs import db_get_bug, db_update_bugs, insert_bug
from app.database.postgre.bugs.pg_bugs import get_bugs as db_g_bugs
...
@router.get(
    ...
    responses={
        404: {"model": ErrorMessage, "description": "Project is not found"},
...
@router.put(
    "/{project_name}/bugs/{bug_internal_id}",
    tags=["Bug"],
    response_model=BugTicketFull,
    status_code=200,
    responses={
