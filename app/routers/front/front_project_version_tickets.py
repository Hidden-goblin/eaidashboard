...
async def get_tickets_for_project_version(
    project_name: str,
    version: str,
    request: Request,
    current_user: User = Security(front_authorize),
) -> HTMLResponse:
...
async def project_version_ticket_edit(
    request: Request,
    project_name: str,
    version: str,
    reference: str,
    ...
    try:
        if header_request(request, "row"):
            return templates.TemplateResponse(
                ...
                {
                    "request": request,
                    "ticket": await get_ticket(project_name, version, reference),
                    "project_name": project_name,
                    "project_name_alias": provide(project_name),
                    "project_version": version,
                },
...
async def project_version_update_ticket(
    request: Request,
    project_name: str,
    version: str,
    reference: str,
